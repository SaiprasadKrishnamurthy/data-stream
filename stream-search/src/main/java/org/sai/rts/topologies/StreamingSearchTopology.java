...
public class StreamingSearchTopology {
    ...
    private StormTopology buildTopology(final ZkHosts kafkaZookeeperHosts) {
        ...
        builder.setBolt("ESPercolatedSearchBolt", new ESPercolatedSearchBolt(), parallelism).shuffleGrouping("TopicSpecificBolt");
        builder.setBolt("KafkaProducerBolt", new KafkaProducerBolt(), parallelism).shuffleGrouping("ESPercolatedSearchBolt");
